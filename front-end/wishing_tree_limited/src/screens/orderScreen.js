...
>>>>>>> 64dd98b (added my orders page and refactor and and a config utils helper)
    if (sessionError) {
...
=======
        ...
        history,
        order,
>>>>>>> b1ecd9a (need to change men, women, kids, discount carousel to card component)
        orderId,
        sessionId,
        session,
        userInfo,
